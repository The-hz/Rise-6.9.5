...
public final class j extends rip.vantage.commons.packet.api.abstracts.a {
    ...
    public j(byte[] var1, byte[] var2, String var3, byte[] var4) {
        this(1, var1, var2, var3, var4);
    }

    private j(int var1, byte[] var2, byte[] var3, String var4, byte[] var5) {
        super((byte)34);
        kD(var1);
        a("challenge", var2, 32);
