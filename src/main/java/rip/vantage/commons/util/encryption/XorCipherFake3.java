...
public class XorCipherFake3 {
    private static final String eQU = "ふぎいかじんぁふぃふにかふざ";

    public XorCipherFake3() {
    }

    public static String kh(String var0) {
        byte[] abyte = "ふぎいかじんぁふぃふにかふざ".getBytes(StandardCharsets.UTF_8);
