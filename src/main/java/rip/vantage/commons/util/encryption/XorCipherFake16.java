...
public class XorCipherFake16 {
    private static final String eQO = "ぁふぃいんじぎふかにかふふざ";

    public XorCipherFake16() {
    }

    public static String kh(String var0) {
        byte[] abyte = "ぁふぃいんじぎふかにかふふざ".getBytes(StandardCharsets.UTF_8);
