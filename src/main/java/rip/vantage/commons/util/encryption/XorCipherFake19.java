...
public class XorCipherFake19 {
    private static final String eQR = "ふぎざふふかにかぁふぃいんじ";

    public XorCipherFake19() {
    }

    public static String kh(String var0) {
        byte[] abyte = "ふぎざふふかにかぁふぃいんじ".getBytes(StandardCharsets.UTF_8);
