...
public class XorCipherFake15 {
    private static final String eQN = "ぁふぃいぎふかにかふふんじざ";

    public XorCipherFake15() {
    }

    public static String encrypt(String var0) {
        byte[] abyte = "ぁふぃいぎふかにかふふんじざ".getBytes(StandardCharsets.UTF_8);
