...
public class XorCipherFake10 {
    private static final String eQI = "ふぃふにかふかぎんぁふいじざ";

    public XorCipherFake10() {
    }

    public static String encrypt(String var0) {
        byte[] abyte = "ふぃふにかふかぎんぁふいじざ".getBytes(StandardCharsets.UTF_8);
