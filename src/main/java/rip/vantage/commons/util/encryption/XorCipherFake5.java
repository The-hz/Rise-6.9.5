...
public class XorCipherFake5 {
    private static final String eQW = "ふぎんぁふふぃふにかいかじざ";

    public XorCipherFake5() {
    }

    public static String kh(String var0) {
        byte[] abyte = "ふぎんぁふふぃふにかいかじざ".getBytes(StandardCharsets.UTF_8);
