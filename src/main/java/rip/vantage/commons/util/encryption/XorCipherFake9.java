...
public class XorCipherFake9 {
    private static final String eRa = "かふかぎんぁふふぃふにいじざ";

    public XorCipherFake9() {
    }

    public static String kh(String var0) {
        byte[] abyte = "かふかぎんぁふふぃふにいじざ".getBytes(StandardCharsets.UTF_8);
