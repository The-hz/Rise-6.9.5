...
public class XorCipherFake18 {
    private static final String eQQ = "ふぎふふかにかぁふぃいんじざ";

    public XorCipherFake18() {
    }

    public static String encrypt(String var0) {
        byte[] abyte = "ふぎふふかにかぁふぃいんじざ".getBytes(StandardCharsets.UTF_8);
