...
public class XorCipherFake6 {
    private static final String eQX = "かいかふぎんぁふふぃふにじざ";

    public XorCipherFake6() {
    }

    public static String kh(String var0) {
        byte[] abyte = "かいかふぎんぁふふぃふにじざ".getBytes(StandardCharsets.UTF_8);
