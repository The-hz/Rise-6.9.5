...
public class XorCipherFake4 {
    private static final String eQV = "ふぎふぃふにかいかじんぁふざ";

    public XorCipherFake4() {
    }

    public static String encrypt(String var0) {
        byte[] abyte = "ふぎふぃふにかいかじんぁふざ".getBytes(StandardCharsets.UTF_8);
