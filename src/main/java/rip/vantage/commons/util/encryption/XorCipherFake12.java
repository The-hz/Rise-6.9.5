...
public class XorCipherFake12 {
    private static final String eQK = "かぎんぁふぃふにかふふいじざ";

    public XorCipherFake12() {
    }

    public static String kh(String var0) {
        byte[] abyte = "かぎんぁふぃふにかふふいじざ".getBytes(StandardCharsets.UTF_8);
