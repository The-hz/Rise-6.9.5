...
public class XorCipherFake14 {
    private static final String eQM = "ぁふぃふかにかふふいぎんじざ";

    public XorCipherFake14() {
    }

    public static String encrypt(String var0) {
        byte[] abyte = "ぁふぃふかにかふふいぎんじざ".getBytes(StandardCharsets.UTF_8);
