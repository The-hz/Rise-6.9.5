...
public class XorCipherFake7 {
    private static final String eQY = "かふぃふにいかふぎんぁふじざ";

    public XorCipherFake7() {
    }

    public static String encrypt(String var0) {
        byte[] abyte = "かふぃふにいかふぎんぁふじざ".getBytes(StandardCharsets.UTF_8);
