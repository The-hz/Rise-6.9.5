...
public class ProtocolInfo {
    public static ProtocolInfo R1_21_11 = new ProtocolInfo("Mounts of Mayhem", "December 9, 2025", ProtocolVersion.v1_21_11);
    public static ProtocolInfo R1_21_9 = new ProtocolInfo("The Copper Age", "September 30, 2025", ProtocolVersion.v1_21_9);
    public static ProtocolInfo R1_21_7 = new ProtocolInfo("Lava Chicken", "June 30, 2025", ProtocolVersion.v1_21_7);
    public static ProtocolInfo R1_21_6 = new ProtocolInfo("Chase the Skies", "June 17, 2025", ProtocolVersion.v1_21_6);
    public static ProtocolInfo R1_21_5 = new ProtocolInfo("Spring to Life", "March 25, 2025", ProtocolVersion.v1_21_5);
    ...
    public static ProtocolInfo fromProtocolVersion(ProtocolVersion var0) {
        for (ProtocolInfo protocolinfo : PROTOCOL_INFOS) {
            if (protocolinfo.getProtocolVersion().getName().equals(var0.getName())) {
                return protocolinfo;
            }
        }
