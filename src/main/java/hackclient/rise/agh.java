...
public final class agh {
    ...
    private final ConcurrentHashMap<Integer, age> aJb = new ConcurrentHashMap();

    public agh(Font font, boolean bl, boolean bl2) {
        this.aIX = font;
        this.aIY = bl;
        this.aIZ = bl2;
    }
    ...
    public void a(char c2, float f2, float f3) {
        char c3 = c2;
        age age2 = this.aJb.get(c3);
        if (age2 == null) {
            age2 = this.l(c2);
            if (age2 == null) {
                return;
            }
            age age3 = this.aJb.putIfAbsent(Integer.valueOf(c3), age2);
            if (age3 != null) {
                age2 = age3;
            }
        }
