        ...
        if (tv.aEg.currentScreen instanceof GuiInventory && tv.aEg.thePlayer.openContainer == container) {
            ...
            for (int i2 = 5; i2 < 45; ++i2) {
                ...
                if (itemStack.getItem() instanceof ItemSword) {
                    if (aie.b(itemStack, container)) {
                        n2 = i2;
                    }
                } else if (itemStack.getItem() instanceof ItemBow) {
                    if (aie.c(itemStack, container)) {
                        n3 = i2;
                    }
                } else {
                    ...
                    if (item instanceof ItemTool) {
                        ...
                        int n4 = aie.d((Item)itemTool);
                        if (aie.b(itemStack, container, n4)) {
                            nArray[n4] = i2;
                        }
                    } else {
                        ...
                        if (item2 instanceof ItemArmor) {
                            ...
                            if (aie.a(itemStack, container, itemArmor.armorType)) {
                                nArray2[itemArmor.armorType] = i2;
                            }
                        }
                    }
                }
                if (aie.a(itemStack, container)) continue;
                arrayList.add(i2);
            }
            boolean bl = true;
