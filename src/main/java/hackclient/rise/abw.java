...
public enum abw {
    ...
    private static final abw[] $VALUES = pX();

    abw(int var3, int var4, int var5, int var6) {
        this.azv = new Color(var3, var4, var5, var6);
    }

    abw(int var3, int var4, int var5) {
    ...
    private static abw[] pX() {
        return new abw[]{BACKGROUND, SECONDARY, TEXT, SECONDARY_TEXT, TRINARY_TEXT, OVERLAY};
    }
}
