...
public enum aht {
    COLLISIONS(var0 -> aih.a(var0.getFirst().get(var0.getFirst().size() - 1)).getMaterial() == Material.air),
    LEGIT(var0 -> {
        ahs ahs = var0.getFirst().get(var0.getFirst().size() - 1);
        return aih.a(ahs.add(0, -1, 0)).getMaterial() != Material.air || aih.a(ahs.add(0, -2, 0)).getMaterial() != Material.air;
    });
