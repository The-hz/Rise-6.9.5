...
public class abd implements InstanceAccess {
    ...
    public void draw(Vector2d var1, int var2, int var3, float var4) {
        ...
        if (flag) {
            ...
            boolean flag1 = agj.c(var1.x, var1.y, this.scale.x, this.scale.y, var2, var3);
    ...
    public void click(int var1, int var2, int var3) {
        if (this.position != null
            ...
            if (agj.c(this.position.x, this.position.y, this.scale.x, this.getStandardClickGUI().axY.getY() - 3.0F, var1, var2) && this.getStandardClickGUI().axX == null) {
                this.ayg = true;
                double d0 = 0.0;

                for (abl ablxx : this.valueList) {
                    d0 += ablxx.getHeight();
                }
            ...
            if (this.oJ()) {
                for (abl ablx : this.getValueList()) {
    ...
    @Generated
    public ArrayList<abl> getValueList() {
