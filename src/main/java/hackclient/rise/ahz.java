...
public final class ahz implements InstanceAccess {
    public static void ab(double var0) {
        a(aia.POSITION, var0, true, true);
    }

    public static void a(aia var0, double var1, boolean var3, boolean var4) {
    ...
    public static void a(aia var0, double var1, int var3, boolean var4, boolean var5) {
