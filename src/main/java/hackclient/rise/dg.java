...
public final class dg extends CreativeTabs implements InstanceAccess {
    ...
    public void displayAllReleventItems(List<ItemStack> var1) {
        ...
        var1.add(itemstack1);
        var1.add(aie.getCustomSkull("Suspicious", "https://education.minecraft.net/wp-content/uploads/server.jpg"));
        var1.add(aie.getCustomSkull("Hentai", "https://education.minecraft.net/wp-content/uploads/cock.png"));
        ItemStack itemstack2 = aie.getItemStack("anvil 1 100");
        itemstack2.setStackDisplayName("§rSpawn Imposter");
        var1.add(itemstack2);
        ItemStack itemstack3 = aie.getItemStack("potion 1 16385 {CustomPotionEffects:[{Id:6,Amplifier:125,Duration:1000000}]}");
        itemstack3.setStackDisplayName("§rSplash Potion of Instant Death");
        var1.add(itemstack3);
        var1.add(aie.getItemStack("dragon_egg"));
        var1.add(aie.getItemStack("barrier"));
        var1.add(aie.getItemStack("command_block"));
        var1.add(aie.getItemStack("command_block_minecart"));
        ItemStack itemstack4 = aie.getItemStack("stone_slab 1 2");
        itemstack4.setStackDisplayName("§rAlpha Slab");
        var1.add(itemstack4);
        ItemStack itemstack5 = aie.getItemStack("leaves 1 4");
        itemstack5.setStackDisplayName("§rAlpha Leaves");
        var1.add(itemstack5);
        var1.add(aie.getItemStack("tallgrass 1 0"));
        ItemStack itemstack6 = aie.getItemStack(
        ...
        var1.add(itemstack6);
        ItemStack itemstack7 = aie.getItemStack("potion 1 16385 {CustomPotionEffects:[{Id:14,Duration:1000000,ShowParticles:0b}]}");
        itemstack7.setStackDisplayName("§rSplash Potion of Infinite Invisibility");
        var1.add(itemstack7);
        ItemStack itemstack8 = aie.getItemStack(
        ...
        var1.add(itemstack8);
        ItemStack itemstack9 = aie.getItemStack(
        ...
        var1.add(itemstack9);
        ItemStack itemstack10 = aie.getItemStack(
        ...
        ItemStack itemstack11 = aie.getItemStack("diamond_chestplate 1 0  {ench:[{id:0,lvl:32767},{id:3,lvl:32767},{id:1,lvl:32767},{id:7,lvl:32767}],Unbreakable:1}");
        itemstack11.setStackDisplayName("§r§b§lGod Chestplate");
        var1.add(itemstack11);
        ItemStack itemstack12 = aie.getItemStack("diamond_leggings 1 0  {ench:[{id:0,lvl:32767},{id:3,lvl:32767},{id:1,lvl:32767},{id:7,lvl:32767}],Unbreakable:1}");
        itemstack12.setStackDisplayName("§r§b§lGod Leggings");
        var1.add(itemstack12);
        ItemStack itemstack13 = aie.getItemStack(
        ...
        ItemStack itemstack14 = aie.getItemStack(
        ...
        ItemStack itemstack15 = aie.getItemStack(
