...
public class abn extends abl {
    ...
    public void draw(Vector2d var1, int var2, int var3, float var4) {
        ...
        if (this.ayI) {
            ...
            boundsnumbervalue.n(ahg.m(boundsnumbervalue.wo().doubleValue(), boundsnumbervalue.wz().doubleValue()));
            if (this.ayK > this.ayL) {
                ...
                boundsnumbervalue.a(ahg.m(boundsnumbervalue.wA().doubleValue(), boundsnumbervalue.wz().doubleValue()));
            }
        } else if (this.ayJ) {
