...
public class ahp extends ArrayList<ahr> implements InstanceAccess {
    public static int aNu = 100;
    public ahs aNv = new ahs((int)aEg.thePlayer.posX, (int)aEg.thePlayer.posY, (int)aEg.thePlayer.posZ);
    public ahs aNw;
    private final ahq aNx = new ahq(100, this.aNv);
    private final ahq aNy = new ahq(100, this.aNv);
    public ahr aNz;
    public Vec3i aNA;
    public int aNB = Integer.MAX_VALUE;
    private final boolean aNC;

    public ahp(ahs var1, boolean var2) {
        this.aNw = var1;
        this.aNC = var2;
    ...
    private void uN() {
        try {
            if (this.isEmpty()) {
                ...
                aht[] aaht = new aht[]{aht.COLLISIONS, aht.LEGIT};
                ...
                for (ahr ahrxxx : this) {
                    ...
                    for (int i = -1; i <= b0; i += b0 * 2) {
                        ...
                        if (ahrx != null && aht.a(ahrx, this, aaht)) {
                            arraylist.add(ahrx);
                        }
                    }
    ...
    private ahr a(ahr var1, int var2, int var3, int var4) {
        ...
        ahs ahsx = ahr.get(ahr.size() - 1);
        ahs ahsx22 = new ahs(ahsx.add(var2, var3, var4));
