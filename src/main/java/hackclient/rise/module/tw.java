...
extends Module {
    ...
    public final Listener<PreUpdateEvent> onPreUpdate = preUpdateEvent -> {
        block27: {
            ...
            block0: while (true) {
                ...
                while (true) {
                    ...
                    for (int i2 = -((Number)this.range.wo()).intValue() + 1; i2 <= ((Number)this.range.wo()).intValue() + 1; ++i2) {
                        ...
                        if (this.aeP != null) {
                            if (!(blockPos.distanceSq((Vec3i)tw.aEg.thePlayer.getPosition()) < this.aeP.distanceSq((Vec3i)tw.aEg.thePlayer.getPosition()))) continue;
                            this.aeP = blockPos;
                            continue;
                        }
                        this.aeP = blockPos;
            ...
            if (this.aeQ.j((Vec3i)entityPlayerSP.getPosition()) <= (double)((Number)this.range.wo()).floatValue()) {
                ...
                if (n9 != -1) {
                    this.aeJ = SlotUtil.getPlayerRelativeBlockHardness((EntityPlayer)entityPlayerSP, (World)tw.aEg.theWorld, this.aeQ, n9);
                } else {
                ...
                if (this.aeK >= f3) {
                    ...
                    tw.aEg.playerController.onPlayerDestroyBlock(this.aeQ, EnumFacing.UP);
                }
                if (n9 != -1) {
                    this.d(SlotComponent.class);
    ...
    public void onDisable() {
        tw.aEg.playerController.curBlockDamageMP = 0.0f;
    }
    ...
    public void m(BlockPos blockPos) {
        ...
        tw.aEg.objectMouseOver.typeOfHit = MovingObjectPosition.MovingObjectType.BLOCK;
    }
