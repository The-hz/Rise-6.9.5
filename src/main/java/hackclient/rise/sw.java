...
public enum sw
{
    ...
    PLAYER_PERFECT_YAW(() -> Double.valueOf(RotationUtil.c(new aka(((RotationSample)RotationSamples.ZI.jq()).ih(), 0.0, ((RotationSample)RotationSamples.ZI.jq()).ij()), new aka(((RotationSample)RotationSamples.ZJ.jq()).ih(), 0.0, ((RotationSample)RotationSamples.ZJ.jq()).ij())).getX())),
    PLAYER_PERFECT_PITCH(() -> Double.valueOf(RotationUtil.c(new aka(((RotationSample)RotationSamples.ZI.jq()).ih(), ((RotationSample)RotationSamples.ZI.jq()).ii(), ((RotationSample)RotationSamples.ZI.jq()).ij()), new aka(((RotationSample)RotationSamples.ZJ.jq()).ih(), ((RotationSample)RotationSamples.ZJ.jq()).ii(), ((RotationSample)RotationSamples.ZJ.jq()).ij())).getY())),
    ...
    PLAYER_YAW_DIFFERENCE_FROM_PERFECT_YAW(() -> Double.valueOf(MathOperation.WRAPPED_TO_180_DISTANCE.a(new Double[] { Double.valueOf(((RotationSample)RotationSamples.ZI.jq()).ik()), sw.PLAYER_PERFECT_YAW.io() }))),
    ENEMY_YAW_DIFFERENCE_FROM_PERFECT_YAW(() -> sw.PLAYER_YAW_DIFFERENCE_FROM_PERFECT_YAW.t(true)),
    PLAYER_PITCH_DIFFERENCE_FROM_PERFECT_PITCH(() -> Double.valueOf(MathOperation.DIFFERENCE.a(new Double[] { Double.valueOf(((RotationSample)RotationSamples.ZI.jq()).il()), sw.PLAYER_PERFECT_PITCH.io() }))),
    ...
    PLAYER_CONTRIBUTION_TO_DELTA_HORIZONTAL_DISTANCE(() -> Double.valueOf((double)sw.HORIZONTAL_DISTANCE.io() - MathOperation.EUCLIDEAN_DISTANCE.a(new Double[] { Double.valueOf(((RotationSample)RotationSamples.ZJ.jq()).ih() - ((RotationSample)RotationSamples.ZI.get(1)).ih()), Double.valueOf(((RotationSample)RotationSamples.ZJ.jq()).ij() - ((RotationSample)RotationSamples.ZI.get(1)).ij()) }))),
    ENEMY_CONTRIBUTION_TO_DELTA_HORIZONTAL_DISTANCE(() -> sw.PLAYER_CONTRIBUTION_TO_DELTA_HORIZONTAL_DISTANCE.t(true)),
    PLAYER_CONTRIBUTION_TO_DELTA_VERTICAL_DISTANCE(() -> Double.valueOf(MathOperation.DIFFERENCE.a(new Double[] { Double.valueOf(MathOperation.DIFFERENCE.a(new Double[] { Double.valueOf(((RotationSample)RotationSamples.ZJ.jq()).ii()), Double.valueOf(((RotationSample)RotationSamples.ZI.get(1)).ii()) })), sw.VERTICAL_DISTANCE.io() }))),
    ...
    DELTA_HORIZONTAL_ANGLE_TO_ENEMY(() -> Double.valueOf(MathOperation.WRAPPED_TO_180_DISTANCE.a(new Double[] { sw.PLAYER_PERFECT_YAW.io(), sw.PLAYER_PERFECT_YAW.C(1) }))),
    DELTA_VERTICAL_ANGLE_TO_ENEMY(() -> Double.valueOf(MathOperation.DIFFERENCE.a(new Double[] { sw.PLAYER_PERFECT_PITCH.io(), sw.PLAYER_PERFECT_PITCH.C(1) }))),
    ...
    PLAYER_FORWARD_PERCENTAGE(() -> Double.valueOf(Math.min(Math.abs(MathOperation.WRAPPED_TO_180_DISTANCE.a(new Double[] { Double.valueOf(((RotationSample)RotationSamples.ZI.jq()).ik()), Double.valueOf((double)sw.PLAYER_HORIZONTAL_MOVEMENT_ANGLE.io() - 90.0) })), Math.abs(MathOperation.WRAPPED_TO_180_DISTANCE.a(new Double[] { Double.valueOf(((RotationSample)RotationSamples.ZI.jq()).ik()), Double.valueOf((double)sw.PLAYER_HORIZONTAL_MOVEMENT_ANGLE.io() + 90.0) }))) / 90.0 * 100.0)),
    PLAYER_FORWARD_DELTA(() -> Double.valueOf(sw.PLAYER_HORIZONTAL_DELTA.io() * sw.PLAYER_FORWARD_PERCENTAGE.io() / 100.0 * (double)((Math.abs(MathOperation.WRAPPED_TO_180_DISTANCE.a(new Double[] { Double.valueOf(((RotationSample)RotationSamples.ZI.jq()).ik()), sw.PLAYER_HORIZONTAL_MOVEMENT_ANGLE.io() })) > 90.0) ? -1 : 1))),
    PLAYER_LATERAL_DELTA(() -> Double.valueOf(sw.PLAYER_HORIZONTAL_DELTA.io() * (1.0 - sw.PLAYER_FORWARD_PERCENTAGE.io() / 100.0) * (double)((Math.abs(MathOperation.WRAPPED_TO_180_DISTANCE.a(new Double[] { Double.valueOf(((RotationSample)RotationSamples.ZI.jq()).ik() + 90.0), sw.PLAYER_HORIZONTAL_MOVEMENT_ANGLE.io() })) > 90.0) ? -1 : 1))),
    ENEMY_FORWARD_DELTA(() -> sw.PLAYER_FORWARD_DELTA.t(true)),
    ENEMY_LATERAL_DELTA(() -> sw.PLAYER_LATERAL_DELTA.t(true)),
    PLAYER_CONTRIBUTION_TO_DELTA_HORIZONTAL_ANGLE_TO_ENEMY(() -> Double.valueOf(MathOperation.WRAPPED_TO_180_DISTANCE.a(new Double[] { sw.PLAYER_PERFECT_YAW.io(), Double.valueOf(RotationUtil.c(new aka(((RotationSample)RotationSamples.ZI.get(1)).ih(), ((RotationSample)RotationSamples.ZI.get(1)).ii(), ((RotationSample)RotationSamples.ZI.get(1)).ij()), new aka(((RotationSample)RotationSamples.ZJ.jq()).ih(), ((RotationSample)RotationSamples.ZJ.jq()).ii(), ((RotationSample)RotationSamples.ZJ.jq()).ij())).getX()) }))),
    ENEMY_CONTRIBUTION_TO_DELTA_HORIZONTAL_ANGLE_TO_PLAYER(() -> sw.PLAYER_CONTRIBUTION_TO_DELTA_HORIZONTAL_ANGLE_TO_ENEMY.t(true)),
    PLAYER_CONTRIBUTION_TO_DELTA_VERTICAL_ANGLE_TO_ENEMY(() -> Double.valueOf(MathOperation.DIFFERENCE.a(new Double[] { sw.PLAYER_PERFECT_PITCH.io(), Double.valueOf(RotationUtil.c(new aka(((RotationSample)RotationSamples.ZI.get(1)).ih(), ((RotationSample)RotationSamples.ZI.get(1)).ii(), ((RotationSample)RotationSamples.ZI.get(1)).ij()), new aka(((RotationSample)RotationSamples.ZJ.jq()).ih(), ((RotationSample)RotationSamples.ZJ.jq()).ii(), ((RotationSample)RotationSamples.ZJ.jq()).ij())).getY()) }))),
    ...
    PLAYER_DELTA_ROTATION(() -> Double.valueOf(MathOperation.EUCLIDEAN_DISTANCE.a(new Double[] { sw.PLAYER_DELTA_YAW.io(), sw.PLAYER_DELTA_PITCH.io() }))),
    PLAYER_ROTATION_DISTANCE_FROM_PERFECT_ROTATIONS(() -> Double.valueOf(MathOperation.EUCLIDEAN_DISTANCE.a(new Double[] { sw.PLAYER_YAW_DIFFERENCE_FROM_PERFECT_YAW.io(), sw.PLAYER_PITCH_DIFFERENCE_FROM_PERFECT_PITCH.io() }))),
    PLAYER_DELTA_ROTATION_DISTANCE_FROM_PERFECT_ROTATIONS(() -> Double.valueOf(MathOperation.DIFFERENCE.a(new Double[] { sw.PLAYER_ROTATION_DISTANCE_FROM_PERFECT_ROTATIONS.io(), sw.PLAYER_ROTATION_DISTANCE_FROM_PERFECT_ROTATIONS.C(1) }))),
    PLAYER_CONTRIBUTION_TO_DELTA_ROTATION_DISTANCE_FROM_PERFECT_ROTATIONS(() -> Double.valueOf(MathOperation.DIFFERENCE.a(new Double[] { sw.PLAYER_ROTATION_DISTANCE_FROM_PERFECT_ROTATIONS.io(), Double.valueOf(MathOperation.EUCLIDEAN_DISTANCE.a(new Double[] { Double.valueOf(MathOperation.WRAPPED_TO_180_DISTANCE.a(new Double[] { Double.valueOf(((RotationSample)RotationSamples.ZI.get(1)).ik()), Double.valueOf(RotationUtil.c(new aka(((RotationSample)RotationSamples.ZI.get(1)).ih(), 0.0, ((RotationSample)RotationSamples.ZI.get(1)).ij()), new aka(((RotationSample)RotationSamples.ZJ.jq()).ih(), 0.0, ((RotationSample)RotationSamples.ZJ.jq()).ij())).getX()) })), Double.valueOf(MathOperation.DIFFERENCE.a(new Double[] { Double.valueOf(((RotationSample)RotationSamples.ZI.get(1)).il()), Double.valueOf(RotationUtil.c(new aka(((RotationSample)RotationSamples.ZI.get(1)).ih(), ((RotationSample)RotationSamples.ZI.get(1)).ii(), ((RotationSample)RotationSamples.ZI.get(1)).ij()), new aka(((RotationSample)RotationSamples.ZJ.jq()).ih(), ((RotationSample)RotationSamples.ZJ.jq()).ii(), ((RotationSample)RotationSamples.ZJ.jq()).ij())).getY()) })) })) }))),
