...
public final class CPSCounter extends Module {
    ...
    private int cps;
    @EventLink
    public final Listener<Render2DEvent> amZ = var1 -> {
        ...
        this.b(gg.REGULAR, 1).c(() -> {
            ...
            double d1 = vector2d.y + this.scale.y / 2.0F - gb.MAIN.a(20, gd.REGULAR).tq() / 4.0F;
        ...
        this.b(gg.BLOOM)
            .c(
                () -> RenderUtil.roundedRectangle(
                    vector2d.x + 0.5, vector2d.y + 0.5, this.scale.x + 6.0F - 1.0F, this.scale.y - 2.0F, this.rz().pl() + 1, this.rz().rE()
                )
            );
    };
    @EventLink
    public final Listener<ClickEvent> ana = var1 -> this.clicked = true;
    @EventLink
    public final Listener<PreMotionEvent> anb = var1 -> {
        this.cps = 0;
