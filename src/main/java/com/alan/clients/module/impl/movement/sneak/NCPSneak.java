...
public class NCPSneak extends Mode<Sneak> {
    @EventLink
    public final Listener<PreMotionEvent> OV = var0 -> {
    ...
    @EventLink
    public final Listener<PostMotionEvent> OW = var0 -> ahj.l(new C0BPacketEntityAction(aEg.thePlayer, Action.START_SNEAKING));
