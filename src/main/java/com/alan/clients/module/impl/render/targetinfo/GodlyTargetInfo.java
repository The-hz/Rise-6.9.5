...
public class GodlyTargetInfo extends Mode<TargetInfo> {
    ...
    @EventLink
    public final Listener<Render2DEvent> avm = var1x -> {
        if (this.aui == null) {
        ...
        if (entity != null) {
            ...
            this.avk.a(flag ? Easing.EASE_IN_BACK : Easing.EASE_OUT_ELASTIC);
            ...
            if (!(this.avk.sG() <= 0.0)) {
                ...
                this.avl.a(Easing.EASE_OUT_QUINT);
                this.avl.h(250L);
                ...
                this.b(gg.REGULAR).c(() -> {
                    ...
                    if (!this.e(Interface.class).aoc.wo()) {
                        ...
                        double d16 = d9 - 4.0;
                        this.rz();
                        RenderUtil.roundedRectangle(d0, d1, d15, d16, 8.0, adv.rK());
                    }

                    double d11 = d8 - 3.5;
                    double d12 = d9 - 4.0;
                    this.rz();
                    RenderUtil.roundedRectangle(d0, d1, d11, d12, 8.0, adv.rK());
                    ...
                    Color color2 = adv.rK();
                    this.rz();
                    color2 = aip.d(color2, (int)(adv.rK().getAlpha() / 1.7F));
                    this.rz();
                    RenderUtil.a(d13, d14, d4, 6.0, 3.0, color2, adv.rK(), true);
                ...
                this.b(gg.REGULAR, 1).c(() -> {
                    ...
                    RenderUtil.dropShadow(3, d0 + 6.0 + d7 - 2.0, d1 + 6.0 + d7 - 2.0, b0 - d6, b0 - d6, 20.0, this.rz().pl() * 2);
