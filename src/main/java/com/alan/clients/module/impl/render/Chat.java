...
extends Module {
    ...
    public Chat() {
        ...
        this.historyIndex = -1;
        this.aqT = "";
        this.textBox = new TextBox(new Vector2d(0.0, 0.0), this.aqL, Color.WHITE, TextAlign.LEFT, "", 1000.0f, ALLOWED_CHARACTERS);
        ...
        this.arc = dt2 -> {
            ...
            switch (n2) {
                case 28: {
                    ...
                    if (!string.startsWith("#") && string.length() > 100 && this.imageManager.Z(string)) {
    ...
    public void mn() {
        ...
        this.lineHeight = this.aqK.height();
        ...
        this.heightAnimation.Q(Math.min(f2, this.lineHeight * (this.chatOpen ? f2 : (float)this.aqW) + (float)(this.lineHeight * (this.chatOpen ? f2 : (float)this.aqW) == 0.0f ? 0 : 7)));
        this.aqE.aHe = new Vector2d(((Number)this.width.wo()).doubleValue(), this.heightAnimation.getValue());
        ...
        if (((Boolean)this.background.wo()).booleanValue()) {
            if (bl) {
                double d3 = this.amf != null ? this.amf.getRoundingRadius() : d2;
        ...
        this.b(ShaderQueueType.REGULAR, 1).c(() -> {
            block29: {
                block30: {
                    ...
                    this.aqF.Q(0.0);
                    vector2d.setY(vector2d.getY() + this.aqF.getValue() - this.scrollHelper.tE());
                    this.scrollHelper.E(this.chatOpen);
                    this.scrollHelper.H(true);
                    this.scrollHelper.V((double)(-this.lineHeight * (float)n2) + this.aqE.aHe.y - 6.0);
                    if (!this.chatOpen) {
                ...
                this.aqF.setValue(this.aqF.getValue() + (double)((float)(n2 - this.aqV) * this.lineHeight));
                this.aqF.Q(this.aqF.getValue());
                this.aqW += n2 - this.aqV;
                this.aqW = (int)Math.max(Math.min((float)((Number)this.maxClosedHeight.wo()).intValue() / this.lineHeight, (float)this.aqW), 0.0f);
            }
            this.aqV = n2;
            ...
            block1: while (true) {
                ...
                if (iterator.hasNext()) {
                    ...
                    double d = this.aqE.apP.y - (double)this.lineHeight + (double)(this.chatOpen ? 0 : 6);
                    ...
                    if (((Boolean)this.background.wo()).booleanValue()) {
                        this.scrollHelper.a(new Vector2d(this.aqE.apP.x + this.aqE.aHe.x - 5.0, this.aqE.apP.y + 5.0), this.aqE.aHe.y - 10.0);
                    }
                    GL11.glDisable(3089);
                    return;
                }
                ...
                block2: while (true) {
                    ...
                    if (iterator2.hasNext()) {
                        ...
                        int n4 = ye2.getRenderWidth(this.mo());
                        int n5 = ye2.getRenderHeight(this.mo());
    ...
    private float a(ChatImage ye2) {
        ...
        return ye2.getRenderHeight(this.mo());
    }
    ...
    private ChatImage a(net.minecraft.client.gui.a a2) {
        ...
        String string = this.imageManager.aa(iChatComponent.getUnformattedText());
        if (string == null) {
            return null;
        }
    ...
    public void mq() {
        ...
        if (bl) {
            this.aqG.setDuration(!this.chatOpen ? 300L : 850L);
            this.aqG.setEasing(!this.chatOpen ? Easing.EASE_IN_EXPO : Easing.EASE_OUT_ELASTIC);
        } else {
            this.aqG.setDuration(0L);
            this.aqG.setEasing(!this.chatOpen ? Easing.EASE_IN_EXPO : Easing.EASE_OUT_ELASTIC);
        }
        this.aqG.Q(!this.chatOpen ? 0.0 : 1.0);
        this.alphaAnimation.Q(this.chatOpen ? 255.0 : 0.0);
        double d2 = this.aqG.getValue() > 1.0 ? 1.0 + (this.aqG.getValue() - 1.0) * 0.4 : this.aqG.getValue();
        this.textBox.bX("");
        if (this.aqG.getValue() <= 0.0) {
            return;
        }
        ...
        if (bl) {
            double d3 = this.amf != null ? this.amf.getRoundingRadius() : 6.0;
            this.b(ShaderQueueType.REGULAR, 1).c(() -> {
                runnable.run();
        ...
        this.textBox.c(this.aqL);
        this.textBox.setPosition(new Vector2d(this.rz().qd() + 5.0f, (float)Chat.aEg.jY.getScaledHeight() - this.aqL.height() - this.rz().qd()));
        this.b(ShaderQueueType.REGULAR, 1).c(() -> {
            runnable.run();
            this.textBox.draw();
            if (this.chatOpen && ((Boolean)this.pinyinChineseIME.wo()).booleanValue()) {
                ...
                for (int i = 0; i < n2; ++i) {
                    ...
                    this.aqL.b(string4, f2, f4, ColorUtil.withBlue(Color.WHITE, Math.min(n, n3)).hashCode());
                }
            }
            if (this.chatOpen && ((Boolean)this.pinyinChineseIME.wo()).booleanValue() && agx.isEnabled() && pinyinHandler.uc()) {
                ...
                if (string5 != null && !string5.isEmpty()) {
                    ...
                    this.aqL.b(string5, f5, f6, ColorUtil.withBlue(new Color(220, 220, 220), n).hashCode());
                    double d = this.aqL.getStringWidth(string5);
                    RenderUtil.d(f5, f6 + this.aqL.height() + 1.0f, d, 1.0, ColorUtil.withBlue(Color.WHITE, Math.min(n, 180)));
                    if (list != null && !list.isEmpty()) {
                        ...
                        this.aqL.b(string7, f7 + 1.0f, f8, ColorUtil.withBlue(Color.WHITE, n).hashCode());
                    }
                }
            }
            GlStateManager.popMatrix();
