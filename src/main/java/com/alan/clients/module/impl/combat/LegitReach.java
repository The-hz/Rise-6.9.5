...
public final class LegitReach extends Module {
    ...
    public BooleanValue pS = new BooleanValue("Render Real Location", this, true);
    public BooleanValue pT = new BooleanValue("Watchdog Mode", this, false);
    ...
    public boolean pZ;
    @EventLink
    public final Listener<PostMotionEvent> qa = var1 -> {
        List list = bv.f(9.0);
        if (list.isEmpty()) {
            this.pZ = true;
    ...
    @EventLink
    public final Listener<PacketReceiveEvent> qb = var1 -> {
    ...
    @EventLink
    public final Listener<Render2DEvent> qc = var1 -> {
        if (this.targetEntity != null && aEg.thePlayer != null) {
            ...
            if (aEg.thePlayer.isSwingInProgress && flag && d0 > 3.0 && this.pT.wo()) {
                aEg.fontRendererObj.b("Reach: " + d0, aEg.jY.getScaledWidth() / 2.0, aEg.jY.getScaledHeight() / 2.0 + 20.0, -1);
            }
        }
    };
    @EventLink
    public final Listener<Render3DEvent> qd = var1 -> {
        if (this.targetEntity != null && this.pS.wo()) {
            if (this.pT.wo()) {
                this.pV.h(0L);
                this.pW.h(0L);
                this.pX.h(0L);
