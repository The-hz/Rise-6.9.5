...
public class BreadCrumbs extends Module {
    private final List<BreadCrumb> amO = new ArrayList<>();
    ...
    public final Listener<PreMotionEvent> onPreMotion = var1 -> {
        if (aEg.thePlayer.lastTickPosX != aEg.thePlayer.posX
            ...
            this.amO.add(new BreadCrumb(new Vec3(aEg.thePlayer.posX, aEg.thePlayer.posY, aEg.thePlayer.posZ), System.currentTimeMillis()));
        }
    ...
    public void m(List<BreadCrumb> var1) {
