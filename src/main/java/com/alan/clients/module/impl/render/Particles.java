...
public final class Particles extends Module {
    ...
    private final BooleanValue apg = new BooleanValue("Always Crit", this, true);
    private final BooleanValue aph = new BooleanValue("Always Sharpness", this, true);
    @EventLink
    public final Listener<AttackEvent> onAttack = var1 -> {
        EntityLivingBase entitylivingbase = var1.dc();
        if (aEg.thePlayer.fallDistance > 0.0F || this.apg.wo() || this.aph.wo()) {
