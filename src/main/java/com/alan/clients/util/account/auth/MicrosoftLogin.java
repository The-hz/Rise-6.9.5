...
public class MicrosoftLogin {
    ...
    public static String extractRefreshTokenFromCookies(String string) {
        ...
        try {
            ...
            a a2 = gson.fromJson(akc.a("https://login.live.com/oauth20_token.srf", "client_id=ba89e6e0-8490-4a26-8746-f389a0d3ccc7&code=" + string2 + "&client_secret=hlQ8Q~33jTRilP4yE-UtuOt9wG.ZFLqq6pErIa2B&grant_type=authorization_code&redirect_uri=http://localhost:8247", false), a.class);
    ...
    public static d login(String string) {
        return MicrosoftLogin.loginWithMicrosoftAccessToken(gson.fromJson(akc.a("https://login.live.com/oauth20_token.srf", "client_id=" + MicrosoftLogin.formValue(CLIENT_ID) + "&client_secret=" + MicrosoftLogin.formValue(CLIENT_SECRET) + "&refresh_token=" + MicrosoftLogin.formValue(string) + "&grant_type=refresh_token&redirect_uri=" + MicrosoftLogin.formValue("http://localhost:8247") + "&prompt=select_account", false), a.class), string);
    }

    public static d loginMarketplaceRefreshToken(String string) {
        return MicrosoftLogin.loginWithMicrosoftAccessToken(gson.fromJson(akc.a("https://login.live.com/oauth20_token.srf", "client_id=00000000402B5328&grant_type=refresh_token&refresh_token=" + MicrosoftLogin.formValue(string) + "&scope=" + MicrosoftLogin.formValue("service::user.auth.xboxlive.com::MBI_SSL"), false), a.class), string);
    }
    ...
    private static d loginWithMicrosoftAccessToken(a a2, String string) {
        ...
        g g3 = gson.fromJson(akc.a("https://xsts.auth.xboxlive.com/xsts/authorize", "{\"Properties\":{\"SandboxId\":\"RETAIL\",\"UserTokens\":[\"" + g2.aFa + "\"]},\"RelyingParty\":\"rp://api.minecraftservices.com/\",\"TokenType\":\"JWT\"}", true), g.class);
        if (g3 == null) {
            return new d();
        }
        e e2 = gson.fromJson(akc.a("https://api.minecraftservices.com/authentication/login_with_xbox", "{\"identityToken\":\"XBL3.0 x=" + g2.aFb.aFc[0].aFd + ";" + g3.aFa + "\"}", true), e.class);
        if (e2 == null) {
            return new d();
        }
        f f2 = gson.fromJson(akc.I("https://api.minecraftservices.com/minecraft/profile", e2.aEU), f.class);
        if (f2 == null) {
            return new d();
        }
    ...
    private static g authenticateXboxLive(String string) {
        return gson.fromJson(akc.a("https://user.auth.xboxlive.com/user/authenticate", "{\"Properties\":{\"AuthMethod\":\"RPS\",\"SiteName\":\"user.auth.xboxlive.com\",\"RpsTicket\":\"" + string + "\"},\"RelyingParty\":\"http://auth.xboxlive.com\",\"TokenType\":\"JWT\"}", true), g.class);
    }
    ...
    implements HttpHandler {
        ...
        private void bk(String string) {
            String string2 = akc.a("https://login.live.com/oauth20_token.srf", "client_id=ba89e6e0-8490-4a26-8746-f389a0d3ccc7&code=" + string + "&client_secret=hlQ8Q~33jTRilP4yE-UtuOt9wG.ZFLqq6pErIa2B&grant_type=authorization_code&redirect_uri=http://localhost:8247", false);
